		...
		<div class="m_body bg-light detailDiv">
			<form id="historyDetailForm" action="<c:url value='/history/add'/>" onsubmit="return checkApprInfoVal()">
				<div class="row my-3">
					...
					<div class="col-2 font-weight-bold" id="HstrySttsDiv1">결재 :</div>
				...
				<div class="row my-3">
					...
					<div class="col-2 AhstryType1 font-weight-bold" id="AhstryType1">
			...
			<div id="footDiv" class="pt-3 font-weight-bold" align="center"></div>
		</div>
	</div>
</div>