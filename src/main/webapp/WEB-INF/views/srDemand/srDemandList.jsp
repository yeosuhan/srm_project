													...
													<div class="card-block ">
														<div class="row">
															<form id="srSearchForm">
																<div class="row">
																	<div class="col-5">
																		<label for="dmndYmdStart">조회 기간</label> <input
																			type="date" name="dmndYmdStart" id="dmndYmdStart">
																		<span>~</span> <input type="date" name="dmndYmdEnd"
																			id="dmndYmdEnd">
																	</div>
																	<div class="col-5">
																	...
																	<div class="col-2"></div>
																	<div class="col-5">
																		<label for="sysCd">관련 시스템</label> <select id="sysCd"
																			name="sysCd">
																...
																<tbody>
																	<tr>
																		...
																		<td><button class="btn btn-info btn-sm"
																				data-toggle="modal" data-target="#srDemandModal">요청
																				상세</button></td>
																	</tr>
																	<tr>
																		<td>2</td>
																	...
																	<tr>
																		...
																		<td>
																			<button class="btn btn-info btn-sm" onclick=""
																				data-toggle="modal"
																				data-target="#approvalHistoryModal">변경 요청
																				승인</button>
																		</td>
																	</tr>
																</tbody>
