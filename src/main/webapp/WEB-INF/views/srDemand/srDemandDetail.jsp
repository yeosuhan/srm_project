			...
			<form action="/" method="post">
				...
				<div class="row  mt-3">
					<div class="col-6">
		                ...
		                <div class="col col-sm-6">
		                   <input type="text" class="form-control" value="2023.02.13." disabled>
		                </div>
					</div>
					<div class="col-6">
				...
				<div class="row mt-3">
					...
					<div class="col-6">
		                ...
		                <div class="col col-sm-6">
		                	<input type="text" class="form-control" value="2023.02.18." disabled>
		                </div>
					</div>
				</div>
				<div class="row mt-3 ml-1">
					<label class="col-sm-2 col-form-label" for="rjctRsn" style="line-height: 120px">SR 내용</label>
               		<div class="col-sm-9 pl-0 pr-4">
                  		<textarea rows="5" cols="5" class="form-control" id="rjctRsn" name="rjctRsn" disabled>테스트 내용</textarea>
					</div>
				</div>
				<div class="row mt-3 ml-1">
					<label class="col-sm-2 col-form-label" style="line-height: 120px">반려 사유</label>
               		<div class="col-sm-9 pl-0 pr-4">
				...
				<div class="row mt-3 ml-1">
					<label class="col-sm-2 col-form-label" style="line-height: 120px">SR 내용</label>
               		<div class="col-sm-9 pl-0 pr-4">
