								...
								<div class="table-responsive">
									<table class="table table-hover text-center">
										<thead>
											<tr>
												<th style="width: 1px;"></th>
												<th style="font-size: 14px;">SR번호 <c:if
												...
												<th class="text-left" style="font-size: 14px; width: 200px;">SR명</th>
												<th class="text-left" style="font-size: 14px;">시스템구분</th>
												<th class="text-left" style="font-size: 14px;">업무구분</th>
												...
												<th style="font-size: 14px;">완료예정일 <c:if
