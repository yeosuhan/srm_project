...
<!-- modernizr js -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/assets/js/SmoothScroll.js"></script>
<script
...
<!-- Accordion js -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/resources/assets/pages/accordion/accordion.js"></script>
<!-- Custom js -->
<script
	src="${pageContext.request.contextPath}/resources/assets/js/pcoded.min.js"></script>
<script
	src="${pageContext.request.contextPath}/resources/assets/js/vertical-layout.min.js "></script>
<script type="text/javascript"
