	...
	<div class="pcoded-inner-navbar main-menu">
        ...
        <div class="pcoded-navigation-label mt-3" data-i18n="nav.category.navigation">MY PORTAL</div>
	        <ul class="pcoded-item pcoded-left-item">
	            <li class="">
	                <a href="${pageContext.request.contextPath}/myportal" class="waves-effect waves-dark">
        ...
        <div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.forms">회원정보 관리</div>
	        <ul class="pcoded-item pcoded-left-item">
	            <li>
	                <a href="${pageContext.request.contextPath}/member/myinfo" class="waves-effect waves-dark">
	            ...
	            <c:if test="${role eq 1 }">
		            <li>
		                <a href="${pageContext.request.contextPath}/institution/detail" class="waves-effect waves-dark">
		...
		<div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.navigation">SR 관리</div>
	        <ul class="pcoded-item pcoded-left-item">
	            <c:if test="${role eq 1}">
		            <li class="">"
		                <a href="${pageContext.request.contextPath}/srdemand/list" class="waves-effect waves-dark">
	            ...
	            <c:if test="${role eq 2 || role eq 3}">
		            <li>
		                <a href="${pageContext.request.contextPath}/srinformation/list" class="waves-effect waves-dark">
        ...
        <div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.forms">게시판</div>
	        <ul class="pcoded-item pcoded-left-item">
	            <li>
	                <a href="${pageContext.request.contextPath}/board/list" class="waves-effect waves-dark">
