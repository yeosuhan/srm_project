	...
	<div class="pcoded-inner-navbar main-menu">
        ...
        <div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.forms">회원정보 관리</div>
	        <ul class="pcoded-item pcoded-left-item">
	            ...
	            <c:if test="${role eq 1 }">
		            <li>
		                <a href="<c:url value='/institution'/>" class="waves-effect waves-dark">
        ...
        <div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.forms">게시판</div>
	        <ul class="pcoded-item pcoded-left-item">
	            <li>
	                <a href=<c:url value='/noticelist'/>" class="waves-effect waves-dark">
	        ...
	        <c:if test="${role eq 3 }">
				<div class="pcoded-navigation-label" style="font-weight: bold;" data-i18n="nav.category.navigation">회원 관리</div>
			        <ul class="pcoded-item pcoded-left-item">
			            <li class="">
			                <a href=<c:url value='/clientslist'/>" class="waves-effect waves-dark">
			            ...
			            <li class="">
			                <a href=<c:url value='/employeeslist'/>" class="waves-effect waves-dark">
			            ...
			            <li class="">
			                <a href=<c:url value='/departmentslist'/>" class="waves-effect waves-dark">
