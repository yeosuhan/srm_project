...
<nav class="pcoded-navbar">
	...
	<div class="pcoded-inner-navbar main-menu">
		...
		<ul class="pcoded-item pcoded-left-item">
			<li class=""><a href="/myportal" class="waves-effect waves-dark">
		...
		<ul class="pcoded-item pcoded-left-item">
			<li class="waves-effect waves-dark ml-4" data-toggle="modal" data-target="#checkPw">
					<span class="pcoded-micon"><i class="ti-home pt-1"></i></span>
					<span class="pcoded-mtext" data-i18n="nav.dash.main">비번확인 임시 탭</span>
					<span class="pcoded-mcaret"></span>
			</li>
			<li><a href="/myinfo" class="waves-effect waves-dark"> <span
					class="pcoded-micon"><i class="ti-user pt-1"></i><b>FC</b></span> <span
					class="pcoded-mtext" data-i18n="nav.form-components.main">내
						정보 관리</span> <span class="pcoded-mcaret"></span>
			</a></li>


			<c:if test="${role eq 1 }">
				<li><a href="/institution" class="waves-effect waves-dark">
						<span class="pcoded-micon"><i class="far fa-building pt-1"></i><b>FC</b></span>
						<span class="pcoded-mtext" data-i18n="nav.form-components.main">내
		...
		<ul class="pcoded-item pcoded-left-item">
			<li><a href="/noticelist" class="waves-effect waves-dark"> <span
					class="pcoded-micon"><i class="fas fa-bullhorn pt-1"></i><b>FC</b></span>
					<span class="pcoded-mtext" data-i18n="nav.form-components.main">공지사항</span>
					<span class="pcoded-mcaret"></span>
			</a></li>
			<li><a href="/qnalist" class="waves-effect waves-dark"> <span
					class="pcoded-micon"><i class="far fa-comments pt-1"></i><b>FC</b></span>
