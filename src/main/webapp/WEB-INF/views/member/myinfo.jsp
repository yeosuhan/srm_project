												...
												<div class="card">
													...
													<div class="row">
														...
														<div class="col-8 card-block">
															<form class="form-material">
																...
																<div class="form-group form-default">
																	<input type="password" name="footer-email"
																		class="form-control" required="" style="width: 50%" value="dfdffffdf">
																...
																<div class="form-group form-default">
																	<input type="text" name="footer-email"
																		class="form-control" required="" style="width: 50%" value="01012345678">
																	<span class="form-bar"></span> <label
																...
																<div class="form-group form-default">
																	<input type="text" name="footer-email"
																		class="form-control" required="" style="width: 50%" value="test@gmail.com">
																	<span class="form-bar"></span> <label
																...
																<div class="form-group form-default">
																	<input type="text" name="footer-email" id="address_kakao"
																		class="form-control" required="" style="width: 50%" value="혜화역 4번출구">
																	<span class="form-bar"></span> <label
																...
																<div class="form-group form-default"
																	style="display: flex;">
																	<p class="col-sm-2 font-weight-bold">기관소속</p>
																	<div class="col-sm-10">워크넷(내부망)</div>
															...
															<div class="d-flex"> 
																 <button class="btn btn-inverse btn-round waves-effect waves-light" style="margin-left: 160px;">저장</button>
															</div> 
														</div>
													</div>
												</div>
