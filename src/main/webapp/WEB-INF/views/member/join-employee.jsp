...
<body>
					...
					<form class="form-material" id="joinForm" action="/join"
						...
						<div class="form-group form-default">
							<input type="text" name="flnm" class="form-control" required=""
								style="width: 50%"> <label class="float-label">이름</label>
						</div>

						<div class="form-group form-default">
							<input type="text" name="telNo" class="form-control" required=""
								style="width: 50%"> <label class="float-label">전화번호</label>
						</div>

						<div class="form-group form-default">
							<input type="text" name="eml" class="form-control" required=""
								style="width: 50%"> <label class="float-label">이메일
								(exa@gmail.com)</label>
						</div>
	...
	<div style="justify-content: center; text-align: center;">
		<button form="joinForm" type="submit"
			class="btn waves-effect waves-light hor-grd btn-oti">Sign Up</button>
	</div>
	</div>
	<!-- Page body end -->
